...
//        this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 124, j + 72 + 12));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontLoaders.arial24.drawString( "minecraft 1.8.8  ", this.width - this.fontRendererObj.getStringWidth("minecraft 1.8.8                                                                                                                ") - 2, this.height -430, -1);

      
        CFontRenderer font = FontLoaders.roboto16;
       
        FontLoaders.arial24.drawString( "Reality is not affiliated with Mojang AB", this.width - this.fontRendererObj.getStringWidth("\"Reality is not affiliated with Mojang AB                                                                                                ") - 2, this.height -400, -1);
        
        FontLoaders.arial24.drawString( "Reality client is made by Nyghtfull", this.width - this.fontRendererObj.getStringWidth("Reality client is made by Nyghtfull                                                                                                    ") - 2, this.height -415, -1);
