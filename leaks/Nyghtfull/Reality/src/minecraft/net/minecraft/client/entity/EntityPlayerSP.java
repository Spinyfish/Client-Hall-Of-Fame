...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void setMoveSpeedNoSTrafe(final EventMove event, final double speed) {
        double forward = (double)this.mc.thePlayer.movementInput.moveForward;
        double strafe = (double)this.mc.thePlayer.movementInput.moveStrafe;
        float yaw = this.mc.thePlayer.rotationYaw;
        if (forward == 0.0 && strafe == 0.0) {
    ...
    public void setMoveSpeed2(final EventMove event, final double speed) {
        double forward = (double)this.mc.thePlayer.movementInput.moveForward;
        double strafe = (double)this.mc.thePlayer.movementInput.moveStrafe;
        float yaw = this.mc.thePlayer.rotationYaw;
        if (forward == 0.0 && strafe == 0.0) {
            ...
            event.setX(forward * speed * Math.cos(Math.toRadians((double)(yaw + 0.0f))) + strafe * speed * Math.sin(Math.toRadians((double)(yaw + 0.0f))));
            event.setZ(forward * speed * Math.sin(Math.toRadians((double)(yaw + 0.0f))) - strafe * speed * Math.cos(Math.toRadians((double)(yaw + 0.0f))));
