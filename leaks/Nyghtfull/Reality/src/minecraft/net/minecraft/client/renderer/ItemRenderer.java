                        ...
                        if (ModuleManager.getModuleByClass(Animations.class).isEnabled()) {
                            switch (Animations.mode.getModeAsString()) {
                                ...
                                case "Clean":
                                    ...
                                    float var162 = MathHelper.sin((MathHelper.sqrt_float(f1) * 3.1415927f));
                                    GlStateManager.rotate((var162 * 30.0f), (-var162), -0.0f, 9.0f);
                                    
                                    GlStateManager.rotate((var162 * 90.0f), 1.0f, (-var162), 0.0f);
                                ...
                                case "Pula":
                                	this.transformFirstPersonItem(f / 1.0f, f1);
                                    float var165 = MathHelper.sin((MathHelper.sqrt_float(f1) * 3.1415927f));
                                    
                                    GlStateManager.rotate((var165 * 200.0f), 1.0f, (-var165), 0.0f);
                                ...
                                case "idk":
                                	this.transformFirstPersonItem(f / 1.0f, f1);
                                	 float var1656 = MathHelper.sin((MathHelper.sqrt_float(f1) * 3.1415927f));
                                     GlStateManager.rotate((var1656 * 30.0f), (-var1656), -0.0f, 9.0f);
                                     
                                     GlStateManager.rotate((var1656 * 30.0f), 1.0f, (-var1656), 0.0f);
                                ...
                                case "Drop":
                               	 ...
                               	 GlStateManager.translate(0.5F, f1 * 0.5F, -0.7F);
