    ...
    public static void drawRoundedImageRect(float x, float y, float x1, float y1, float radius) {
        ...
        for (i = 0; i <= 90; i += 3)
            worldrenderer.pos(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y + radius + Math.cos(i * Math.PI / 180.0D) * radius * -1.0D, 0)
                    .tex(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y + radius + Math.cos(i * Math.PI / 180.0D) * radius * -1.0D)
                    .endVertex();
        for (i = 90; i <= 180; i += 3)
            worldrenderer.pos(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y1 - radius + Math.cos(i * Math.PI / 180.0D) * radius * -1.0D, 0)
                    .tex(x + radius + Math.sin(i * Math.PI / 180.0D) * radius * -1.0D, y1 - radius + Math.cos(i * Math.PI / 180.0D) * radius * -1.0D)
                    .endVertex();
        for (i = 0; i <= 90; i += 3)
            worldrenderer.pos(x1 - radius + Math.sin(i * Math.PI / 180.0D) * radius, y1 - radius + Math.cos(i * Math.PI / 180.0D) * radius, 0)
                    .tex(x1 - radius + Math.sin(i * Math.PI / 180.0D) * radius, y1 - radius + Math.cos(i * Math.PI / 180.0D) * radius)
                    .endVertex();
        for (i = 90; i <= 180; i += 3)
            worldrenderer.pos(x1 - radius + Math.sin(i * Math.PI / 180.0D) * radius, y + radius + Math.cos(i * Math.PI / 180.0D) * radius, 0)
                    .tex(x1 - radius + Math.sin(i * Math.PI / 180.0D) * radius, y + radius + Math.cos(i * Math.PI / 180.0D) * radius)
                    .endVertex();
        tessellator.draw();
        glEnable(3553);
        glDisable(3042);
