...
import store.femboy.spring.custommenus.MainMenu;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public static boolean doneLoadingTerrain;
    ...
    {
        EventSendPacket packet = new EventSendPacket(p);
        Spring.INSTANCE.getBus().call(packet);
