...
public class GuiVideoSettings extends GuiScreenOF
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, "Colton Conley Ultra 4K LOLI HD 94 Settings", this.width / 2, 15, 16777215);
        String s = Config.getVersion();
        String s1 = "HD_U";

        if (s1.equals("HD"))
        {
            s = "Colton Conley Ultra 4K LOLI HD 94";
        }
