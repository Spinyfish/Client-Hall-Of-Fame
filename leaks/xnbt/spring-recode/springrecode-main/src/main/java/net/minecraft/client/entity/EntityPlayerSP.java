...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            super.onUpdate();
            Spring.INSTANCE.getBus().call(new EventUpdate());
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        {
            EventMotion e = new EventMotion(this.posX, getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
            e.setType(EventType.PRE);
            Spring.INSTANCE.getBus().call(e);
    ...
    public void sendChatMessage(String message)
    {
        ...
        Spring.INSTANCE.getBus().call(event);
